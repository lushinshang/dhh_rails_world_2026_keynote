---
title: 拒絕黑色藥丸
subtitle: DHH 在 Rails World 2026 開場演講裡，講了一個關於柯達 Brownie、Rust 黑盒與馬丁路德的故事
date: 2026-09-25
language: zh-Hant-TW
sources:
  - type: 影片（YouTube）
  ...
  - type: 逐字稿
    title: Rails World 2026 Opening Keynote - DHH（英文字幕）
    local_path: transcription/Rails_World_2026_Opening_Keynote_-_DHH_vDjW_dRyKXY.srt
  - type: 網站
    title: dhh.dk（David Heinemeier Hansson 個人網站）
    url: https://dhh.dk/
---
...
![攝影的平民化用了將近兩百年，從宮廷肖像畫走到每年兩兆張照片；軟體的平民化則從手工程式碼時代，走到 2025 年 11 月 24 日 Claude Opus 4.5 這個分水嶺，正式進入 Agent 時代。](images/timeline-photography-software.png)
...
![一支由終端機提示符號構成的鑰匙，同時連接信箱、任務看板、搜尋與行事曆——CLI 是 agent 用來直接操作所有應用程式的通用協定。](images/cli-universal-key.png)
...
這個「自動化沒有讓需求萎縮，反而擴大市場」的故事方向是對的，是經濟學裡談自動化悖論時常被引用的經典案例。但要老實說一句：DHH 現場講的具體人數——1950 年代三萬名行員、2010 年代四萬名——比公開統計小了大約一個量級。美國勞工統計局與相關學術研究（如波士頓大學 James Bessen 的著作）顯示，1970 年代美國銀行行員大約是三十萬人上下，到 2000 到 2010 年代高峰時逼近五六十萬人。DHH 想傳達的道理——自動化擴大了市場，而不是簡單地零和取代——在經濟學文獻裡站得住，只是他報出來的那組數字，聽起來更像是一個好記的故事版本，不是精確的歷史數字，聽眾如果要引用，最好去查一手統計而不是照搬他的說法。
...
![一位改教者把卷軸釘上教堂大門，卷軸的邊緣正化為發光的終端機介面，遠方一群人各自對著筆電敲打——象徵 agent 讓所有人都能繞過程式設計師這個「祭司階層」，直接與機器對話。](images/agent-luther-reformation.png)
...
- Rails World 2026 Opening Keynote - DHH（YouTube）：[https://www.youtube.com/watch?v=vDjW_dRyKXY](https://www.youtube.com/watch?v=vDjW_dRyKXY)
- David Heinemeier Hansson 個人網站：[https://dhh.dk/](https://dhh.dk/)
- Anthropic 官方公告《Introducing Claude Opus 4.5》：[https://www.anthropic.com/news/claude-opus-4-5](https://www.anthropic.com/news/claude-opus-4-5)
- Claude 官方 Release Notes：[https://support.claude.com/en/articles/12138966-release-notes](https://support.claude.com/en/articles/12138966-release-notes)
- Shopify Engineering《Migrating Shop app from React Native to native》：[https://shopify.engineering/shop-app-migration](https://shopify.engineering/shop-app-migration)
- Sackman, Erikson & Grant (1968), *Exploratory Experimental Studies Comparing Online and Offline Programming Performance*, Communications of the ACM 11(1)：[https://dl.acm.org/doi/10.1145/362851.362858](https://dl.acm.org/doi/10.1145/362851.362858)
- James Bessen, *Learning by Doing: The Real Connection between Innovation, Wages, and Wealth*, Yale University Press, 2015
- 美國勞工統計局（BLS）職業就業統計：[https://www.bls.gov/oes/](https://www.bls.gov/oes/)
- Omarchy 官方網站（Omacom Foundation 贊助資訊）：[https://omarchy.org](https://omarchy.org)
